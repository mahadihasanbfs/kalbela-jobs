...
import Accomplishments from "./small_components/Accomplishments"
...
import LinkAccountsSM from "./small_components/LinkAccounts"
...
function MobileProfileView({
  ...
  if (activeSection === "linkAccounts") {
    return <LinkAccountsSM setActiveSection={setActiveSection} />
  }
  ...
  if (activeSection === "accomplishments") {
    return <Accomplishments setActiveSection={setActiveSection} />
  }
          ...
          <TabsContent value="home" className="m-0">
            ...
            >
              <AccordionItem className="border" value="item-1">
                <AccordionTrigger className="font-regular flex items-center gap-2 bg-gray-50 px-4 text-lg">
