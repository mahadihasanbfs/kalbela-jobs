        ...
        <div>
            <div
                ...
                <div className='mx-auto h-full mt-[-60px] w-full max-w-screen-3xl px-4 md:px-20 lg:px-6 2xl:max-w-screen-xl flex items-center justify-center'>
                    <SemiUnskilledSearchAction title='Skilled Workers' />
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div className="md:col-span-3 bg-white p-4 shadow-md rounded">
                            <SemiJobHeader
                                ...
                                description="Skilled workers around the world including Bangladesh are creating and submitting their Resume/CV to find their desirable job that matches their skilled fields from renowned local and international employers within their country or globally within their local community. It is notable that, jobs in this category may require certification, licensing and experience." />
                            <JobTabs />
