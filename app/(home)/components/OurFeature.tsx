            ...
            <section className="py-12 bg-white sm:py-16 lg:py-20">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-2 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-16">
                        ...
                        <div className="md:p-8 group lg:p-14 md:border-l md:border-gray-200">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={64}
                                height={64}
                        ...
                        <div className="md:p-8 duration-200 group lg:p-14 md:border-t md:border-gray-200">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={64}
                                height={64}
                        ...
                        <div className="md:p-8 duration-200 group lg:p-14 md:border-l md:border-gray-200 md:border-t">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={64}
                                height={64}
                        ...
                        <div className="md:p-8 group lg:p-14 md:border-l md:border-gray-200 md:border-t">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={64}
                                height={64}
